...
grpcurl -plaintext \
    ...
    127.0.0.1:50051 \
    catalog.v1.PcPartStoreService/CreatePcPart
```
...
grpcurl -plaintext \
    ...
    127.0.0.1:50051 \
    catalog.v1.PcPartStoreService/GetPcPart
```
...
grpcurl -plaintext \
    ...
    127.0.0.1:50051 \
    catalog.v1.PcPartStoreService/UpdatePcPart
```
...
grpcurl -plaintext \
    ...
    127.0.0.1:50051 \
    catalog.v1.PcPartStoreService/DeletePcPart
```